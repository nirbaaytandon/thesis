...
%	      \citep{roberta}
  ...
  \chapter{Architecture Creation}\label{c4}
  	...
  	The literature reviewed in chapter \ref{c2litrev} highlights some exceptional work that has been done in the field of NLP, LSTM and Transformer architectures. This chapter lays the groundwork for the improvements proposed in chapter \ref{c3researchmeth}. Starting off with a review of the drawbacks of the architectures that have been chosen for benchmarks and comparisons, then the improvements are proposed to a BERT based DistilBERT architecture are mentioned in section \ref{c42}. Finally, the refinement steps are mentioned in section \ref{c43}.
       ...
       \section{Proposed Architecture Improvements}\label{c42}
            ...
            The DistilBertForQuestionAnsweringC class takes a pre-trained model config file as input along with the embedded inputs, passes thrm through a linear layer and a dropout layer. 
