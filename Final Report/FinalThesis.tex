...
\citep{fastQA}
  ...
  \chapter{Data Analysis \& Architecture Creation}\label{c4}
      \section{Data Analysis}\label{c41}
      \section{Existing Models And Benchmarks}\label{c42}
       ...
       \section{Drawbacks Of Current Architectures}\label{c43}
       \section{Proposed Architecture Improvements}\label{c44}
       \section{Architecture Refinement}\label{c45}
