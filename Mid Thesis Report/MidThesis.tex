   ...
   % \section{Architecture Refinement}\label{c43}
    \begin{appendices}
    	\chapter{Gantt Chart}\label{cgc}
		    ...
		    \end{figure}
		\chapter{Research Proposal}\label{researchProposal}
		...
		\begin{enumerate}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[scale=0.25]{../images/transformer.png}
				\label{fig1}
		...
		\includegraphics[width=180mm,height=120mm,angle=90]{../images/g2.png}
    \end{appendices}
